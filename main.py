...
tamanho_da_população = 50
número_de_gerações = 100
taxa_de_mutação = 0.05
taxa_de_cruzamento = 0.5
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if escolha == '1':
            treino(ambiente, nome_do_arquivo, tamanho_da_população, número_de_gerações, taxa_de_mutação, taxa_de_cruzamento, modelo)
        elif escolha == '2':
